...
class FrogPriorMamba(nn.Module):
    """
    FrogPrior-Mamba model for bioacoustic enhancement using time-frequency
    Mamba blocks.
    ...
    def __init__(self, cfg):
        """
        Initialize the FrogPrior-Mamba model.
        
        Args:
        - cfg: Configuration object containing model parameters.
        """
        super(FrogPriorMamba, self).__init__()
        self.cfg = cfg
    ...
    def forward(self, noisy_mag, noisy_pha):
        """
        Forward pass for the FrogPrior-Mamba model.
