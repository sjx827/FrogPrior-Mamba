...
def inference(args, device):
    ...
    model = FrogPriorMamba(cfg).to(device)
...
def main():
    ...
    parser.add_argument('--input_folder', default='data/processed/valid/noisy')
    parser.add_argument('--output_folder', default='results/FrogPriorMamba_valid')
